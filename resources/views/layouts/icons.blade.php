<div class="flex flex-wrap mx-auto">
    ...
    <a href="?{{ $i }}" class="border-gray-400 bg-gray-50 flex flex-row m-1 ">
        <div class="flex border-l-blue-300 border-l-8 w-72 h-24 transition duration-500 shadow ease-in-out transform hover:-translate-y-1 hover:border-l-blue-600 hover:shadow-lg select-none cursor-pointer bg-white p-2 rounded-md">
